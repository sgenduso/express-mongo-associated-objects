...
router.get('/', function(req, res, next) {
  ...
  people.find({}, function (err, people) {
    ...
    addresses.find({_id: {$in: addressIds}}, function (err, peopleAddresses) {
      ...
      employers.find({_id: {$in: employerIds}}, function (err, employers) {
        joinPersonEmployer(people, employers)
        var employerAddressIds = employers.map(function (employer) {
          return employer.addressId
        })
        addresses.find({_id: {$in: employerAddressIds}}, function (err, employerAddresses) {
